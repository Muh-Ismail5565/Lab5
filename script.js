...
function searchPlayer() {
    ...
    const Players = data.filter(player => player.name.toLowerCase().includes(input));
    getTable(Players);
}
...
teamFilter.appendChild(teamoption);


let pointsOption = document.createElement("option");
pointsOption.value = "Points";
pointsOption.textContent = "Points";
teamFilter.appendChild(pointsOption);
...
function filterBy() {
    ...
    if (filterValue === "Team") {
        document.querySelectorAll(player.points, player.assists, player.rebounds).forEach(cell => {
            cell.style.display = "none";
        });
         
    } else if (filterValue === "Points") {
       document.querySelectorAll(player.team).forEach(cell => {
        cell.style.display = "none";
       });
    }
...
document.getElementById("team-filter").addEventListener("change",filterBy);